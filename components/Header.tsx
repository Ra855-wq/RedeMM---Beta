  ...
  return (
    <header className="bg-white/80 backdrop-blur-md border-b border-neutral-100 px-6 py-3 flex items-center justify-between sticky top-0 z-40 h-16">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="p-2.5 bg-neutral-50 text-neutral-400 hover:text-neutral-900 hover:bg-neutral-100 rounded-full transition-all relative border border-neutral-100">
          <Bell size={18} />
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-neutral-100">
           ...
           <div className="w-10 h-10 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center text-white font-black text-xs shadow-lg">
              {userName[0]}
           </div>
        </div>
      </div>
